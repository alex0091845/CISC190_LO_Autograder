...
class CanvasApi:
    ...
    def get_course_info(self, course_id):
        ...
        """
        url = f"{self.api_base_url}/courses/{course_id}"
        response = requests.get(url, headers=self.headers)
        response.raise_for_status()  # Raise an error for bad responses
        return response.json()

    def get_all_students(self, course_id):
        """
        ...
        """
        students = []
        url = f"{self.api_base_url}/courses/{course_id}/users"
    ...
    def fetch_submissions(self, course_id: str, user_id: int, include_history: bool = False) -> list:
        ...
        """
        submissions: list = []
        url = f"{self.api_base_url}/courses/{course_id}/students/submissions"
        params = {
            'student_ids[]': user_id,
            "per_page": 100,
    ...
    def fetch_all_assignments(self, course_id: str) -> list:
        ...
        """
        assignments = []
        url = f"{self.api_base_url}/courses/{course_id}/assignments"
        params = {
            "per_page": 100
        }
    ...
    def fetch_assignment_rubric(self, course_id, assignment_id):
        """
        ...
        """
        url = f"{self.api_base_url}/courses/{course_id}/assignments/{assignment_id}"
        params = {
    ...
    def send_canvas_message(self, user_id, subject, body):
        """
    ...
    def update_assignment_score_and_rubric(
        ...
        url = f"{self.api_base_url}/courses/{course_id}/assignments/{assignment_id}/submissions/{user_id}"
