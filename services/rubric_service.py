...
from api import fetch_assignment_rubric, update_assignment_score_and_rubric
...
class RubricService:
    ...
    def get_rubric_by_id(self, assignment_id: str) -> dict | None:
        ...
        if not self.rubric_repository.has_rubric(assignment_id):
            ...
            rubric = fetch_assignment_rubric(self.context.get("course_id"), assignment_id)
    ...
    def update_rubric_assessment(self, lo_result: LoResult, assignment_id: int, student_id: int) -> None:
        ...
        update_assignment_score_and_rubric(
